<?php
	include($_SERVER['DOCUMENT_ROOT']."/printshop/private/header.php");
	include($_SERVER['DOCUMENT_ROOT']."/printshop/private/nav.php");
...
include($_SERVER['DOCUMENT_ROOT']."/printshop/private/footer.php") 
?>
