<?php ob_start() ?>
<?php
/* Sessions created by Shane */ require_once($_SERVER['DOCUMENT_ROOT']."/printshop/private/session.php"); 	
...
require_once($_SERVER['DOCUMENT_ROOT']."/printshop/private/functions.php"); 
require_once($_SERVER['DOCUMENT_ROOT']."/printshop/private/validation_functions.php");
